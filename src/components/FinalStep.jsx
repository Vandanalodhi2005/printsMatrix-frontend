...
export default function FinalStep({ onBack, onSubmit, nameRef, loading, modelValue, setModelValue }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Validate phone for USA/Canada: must start with +1 and have 11 digits
    if (!validatePhone(form.phone)) {
      setPhoneError('Invalid phone number. Please enter a valid USA/Canada number starting with +1 and 11 digits.');
      return;
    }
    setPhoneError('');
    onSubmit(e, form);
